...
if __name__ == "__main__":
    anno_data_file_path = '/data2/Meva/mevaTrainTestList/trainC/mevaC.json'
    pred_file_path = '/data2/Meva/result/trainC/vidtest/testtop10.json'
    kineticseval = KINETICSclassification(ground_truth_filename=anno_data_file_path,
                           prediction_filename=pred_file_path,
                           verbose=True, check_status=False, subset='testing')
