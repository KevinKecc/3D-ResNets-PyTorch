...
from train_flow import train_epoch
from validation import val_epoch
import test
from FGS3D_flow import FGS3DFLOW
...
if __name__ == '__main__':
    ...
    if opt.arch == 'FGS3D-0':
        ...
        model = FGS3DFLOW(num_classes=num_class, dropout_keep_prob=0.0)
